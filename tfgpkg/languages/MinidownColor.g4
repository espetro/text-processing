...
word : '(' prefix=STYLE value=(WORD|COLOR) suffix=STYLE ' , ' font=COLOR ' , ' bg=COLOR ')'
     | '(' prefix=STYLE value=(WORD|COLOR) ' , ' font=COLOR ' , ' bg=COLOR ')'
     | '(' value=(WORD|COLOR) suffix=STYLE ' , ' font=COLOR ' , ' bg=COLOR ')'
     | '(' value=(WORD|COLOR) ' , ' font=COLOR ' , ' bg=COLOR ')'
     ;

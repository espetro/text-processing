...
class WordSegmentation:
    ...
    For a simpler explanation of the algorithm, please see:
    ...
    @staticmethod
    @nb.njit(cache=True)
    def get_word_boxes(image: ndarray, proj: array, height: int, min_ws_length=5,
        min_avg_ws_length=11, avg_factor=0.9, block_sz_factor=1.8):
        """"""
        ...
        # mean whitespace block size has to be greater than X=11 (on avg)

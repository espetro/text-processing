...
class SegmentationNetwork:
    ...
    DEPRECATED: Mxnet Gluon has been removed from the package. All deep networks must use Tensorflow 2.x or Keras.

    A simplified version for MXnet can be reviewed at:
        @awslabs/handwritten-text-recognition-for-apache-mxnet (GitHub)
    """
    MODEL_PATH = pkg_resources.files("preproc.paragraph.data").joinpath("cnn_mse.params")
